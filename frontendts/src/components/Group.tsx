...
export default function Group(props: any) {
  ...
  const random = uuidv4();
  const cpfunction = () => {
    const random: any = localStorage.getItem("random");
        ...
        <div className="grouppanel">
          ...
          {display.dis && (
            <div className="clipboard">
              ...
              <i
                onClick={cpfunction}
                className="fa-regular fa-clipboard fa-flip-horizontal fa-2xl"
                style={{ color: "#198754" }}
              ></i>
            </div>
          )}
...
//Perfect Tits MILF Becomes Dirty Cheating Slut With Big Dick Waiter (Octavia Red)
